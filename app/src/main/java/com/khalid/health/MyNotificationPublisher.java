...
import com.khalid.health.ui.MainActivity;
...
public class MyNotificationPublisher extends BroadcastReceiver {
    ...
    public static void scheduleNotification(Context context, long delay) {//delay is after how much time(in millis) from current time you want to schedule the notification
